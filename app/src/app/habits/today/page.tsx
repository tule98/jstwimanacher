...
import HabitCardNew from "../_components/HabitCardNew";
...
export default function HabitsTodayPage() {
  ...
  const handleDrop = async (e: React.DragEvent, dropIndex: number) => {
    ...
    const dragIndex = todayHabits.findIndex((h) => h.id === draggedHabitId);
    if (dragIndex === dropIndex || dragIndex === -1) {
      setDraggedHabitId(null);
      return;
    }

    // Reorder habits locally
              ...
              return (
                ...
                >
                  <HabitCardNew
                    ...
                    dragHandleProps={{
                      onMouseDown: () => handleDragStart(habit.id),
                    }}
                  />
                </Box>
              );
